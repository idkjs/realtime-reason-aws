...
function DemoWonkaShare(Props) {
  ...
  React.useEffect((function () {
          ...
          var sub = Wonka.forEach((function ($$event) {
                    var message = API$ReactTemplate.extractMessageFrom($$event);
                    return Curry._1(setMessage, (function (param) {
                                  return message;
                                }));
                  }))(API$ReactTemplate.subscribeToObservable(graphqlOperation));
...
var make = DemoWonkaShare;

var $$default = DemoWonkaShare;
